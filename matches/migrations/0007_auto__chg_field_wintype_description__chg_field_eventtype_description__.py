...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WinType.description'
        db.alter_column('matches_wintype', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True))

        # Changing field 'EventType.description'
        db.alter_column('matches_eventtype', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True))

        # Changing field 'MatchTypeAspect.description'
        db.alter_column('matches_matchtypeaspect', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'WinType.description'
        db.alter_column('matches_wintype', 'description', self.gf('django.db.models.fields.CharField')(max_length=127, primary_key=True))

        # Changing field 'EventType.description'
        db.alter_column('matches_eventtype', 'description', self.gf('django.db.models.fields.CharField')(max_length=127, primary_key=True))

        # Changing field 'MatchTypeAspect.description'
        db.alter_column('matches_matchtypeaspect', 'description', self.gf('django.db.models.fields.CharField')(max_length=127, primary_key=True))
