...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('matches_venue', (
            ('country', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=127)),
        ))
        ...
        #db.add_column('matches_match', 'title', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='title_matches', null=True, to=orm['promotions.Title']), keep_default=False)

        # Adding field 'Card.broadcast_viewership'
        db.add_column('matches_card', 'broadcast_viewership', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Card.series'
        db.add_column('matches_card', 'series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matches.CardSeries'], null=True, blank=True), keep_default=False)

        # Adding field 'Card.venue'
        db.add_column('matches_card', 'venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matches.Venue'], null=True, blank=True), keep_default=False)

        # Adding field 'Card.live_attendance'
        db.add_column('matches_card', 'live_attendance', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('matches_match', 'title_id')

        # Deleting field 'Card.broadcast_viewership'
        db.delete_column('matches_card', 'broadcast_viewership')

        # Deleting field 'Card.series'
        db.delete_column('matches_card', 'series_id')

        # Deleting field 'Card.venue'
        db.delete_column('matches_card', 'venue_id')

        # Deleting field 'Card.live_attendance'
        db.delete_column('matches_card', 'live_attendance')
