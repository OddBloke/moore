...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.time'
        db.add_column('matches_match', 'time', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.time'
        db.delete_column('matches_match', 'time')
