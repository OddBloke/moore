...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.win_type'
        db.add_column('matches_match', 'win_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matches.WinType'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Match.win_type'
        db.delete_column('matches_match', 'win_type_id')
