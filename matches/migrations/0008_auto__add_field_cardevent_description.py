...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardEvent.description'
        db.add_column('matches_cardevent', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardEvent.description'
        db.delete_column('matches_cardevent', 'description')
