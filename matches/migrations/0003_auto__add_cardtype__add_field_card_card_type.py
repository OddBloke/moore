...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('matches_card', 'card_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['matches.CardType']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('matches_card', 'card_type_id')
