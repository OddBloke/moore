...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Persona.billed_name'
        db.delete_column('wrestlers_persona', 'billed_name')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Persona.billed_name'
        raise RuntimeError("Cannot reverse this migration. 'Persona.billed_name' and its values cannot be restored.")
