...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Persona.billed_name'
        db.add_column('wrestlers_persona', 'billed_name', self.gf('django.db.models.fields.CharField')(default='FIXME', max_length=128), keep_default=False)
