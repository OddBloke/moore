...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for persona in orm.Persona.objects.all():
            persona.billed_name = persona.wrestlingentity_ptr.name
            persona.save()
    ...
    def backwards(self, orm):
        ...
        for persona in orm.Persona.objects.all():
            persona.wrestlingentity_ptr.name = persona.billed_name
            persona.wrestlingentity_ptr.save()
