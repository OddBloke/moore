...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WrestlingEntity.name'
        db.delete_column('wrestlers_wrestlingentity', 'name')


    def backwards(self, orm):
        
        # Adding field 'WrestlingEntity.name'
        db.add_column('wrestlers_wrestlingentity', 'name', self.gf('django.db.models.fields.CharField')(default='Migration 0009 fixes this', max_length=128), keep_default=False)
