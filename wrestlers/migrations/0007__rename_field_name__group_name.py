...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Group.name' to 'Group.group_name'
        db.rename_column('wrestlers_group', 'name', 'group_name')
        db.alter_column('wrestlers_group', 'group_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Group.name'
        raise RuntimeError("Cannot reverse this migration. 'Group.name' and its values cannot be restored.")

        # Deleting field 'Group.group_name'
        db.delete_column('wrestlers_group', 'group_name')
