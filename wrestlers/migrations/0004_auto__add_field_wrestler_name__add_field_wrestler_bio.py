...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Wrestler.name'
        db.add_column('wrestlers_wrestler', 'name', self.gf('django.db.models.fields.CharField')(default='FIXME', max_length=128), keep_default=False)

        # Adding field 'Wrestler.bio'
        db.add_column('wrestlers_wrestler', 'bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Wrestler.name'
        db.delete_column('wrestlers_wrestler', 'name')

        # Deleting field 'Wrestler.bio'
        db.delete_column('wrestlers_wrestler', 'bio')
